...
/* === Static Methods === */
    ...
    // 'hire' a ChildProcess
    public static function hire_cp(name : String):Worker {
        var cp = ChildProcess.fork( './scripts/worker' );
        return new NodeWorker( cp );
    }

    public static function hire_ww(name : String):Worker {
