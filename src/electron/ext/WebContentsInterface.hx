...
interface WebContentsInterface {
/* === Instance Methods === */
	...
	//function send(channel:String, data:Rest<Dynamic>):Void;
...
typedef LoadUrlOptions = {
	...
	?userAgent:String,
	?extraHeaders:String,
	?postData:Array<Dynamic>
};

typedef OpenDevToolsOptions = {
	mode : DevToolsDockingMode
};

@:enum
abstract DevToolsDockingMode (String) from String to String {
	var Right = 'right';
	var Bottom = 'bottom';
