...
/* === Instance Methods === */
	...
	private function updateSize(stage : Stage):Void {
		if (thumb != null) {
			...
			thumbRect = thumbRect.scale(null, (0.2 * vp.height)).floor();
	...
	/**
	  ...
	  */
	private function getTotalRect():Rect<Int> {
		var r:Rect<Int> = new Rect();
		if (thumb != null) {
...
/* === Computed Instance Fields === */
	...
	private inline function get_thumb():Null<Canvas> return bar._thumb;
